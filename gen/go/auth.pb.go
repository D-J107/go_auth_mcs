...
func (x *ValidateRequest) GetUserId() uint64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
const file_auth_proto_rawDesc = "" +
	...
	"\aisValid\x18\x01 \x01(\bR\aisValid2\xb6\x01\n" +
	"\x04Auth\x129\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x12A\n" +
	"\x10ValidatePassword\x12\x15.auth.ValidateRequest\x1a\x16.auth.ValidateResponseB\aZ\x05/authb\x06proto3"
...
var file_auth_proto_depIdxs = []int32{
	...
	4, // 2: auth.Auth.ValidatePassword:input_type -> auth.ValidateRequest
	1, // 3: auth.Auth.Register:output_type -> auth.RegisterResponse
	3, // 4: auth.Auth.Login:output_type -> auth.LoginResponse
	5, // 5: auth.Auth.ValidatePassword:output_type -> auth.ValidateResponse
